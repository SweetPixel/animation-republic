...
<html lang="en">
    ...
    <body>
        <div class="container">
            <div class="row">
                <img class="img-responsive center-block" width="100%" height="100%" src="assets/images/Under_Construction.svg" alt="under_construction" />
            </div>
            <div class="row text-center">
                <div class="col-md-6 col-md-offset-3">
                    <h3>Hi folks! our website will be live soon, in the meanwhile you can check our videos on <a class="link" target="_blank" href="https://vimeo.com/animationrepublic">vimeo</a> , or contact us for any query or quote for a video at:
                        <a class="link" href="mailto:hello@animation-republic.com">hello@animation-republic.com</a></h3>
                </div>
                <div class="col-md-3"></div>
            </div>
            <div class="row text-center">
                <a href="https://vimeo.com/animationrepublic" target="_blank"><img src="assets/images/Vimeo.svg" rel="vimeo"/></a>
            </div>
        </div>
                    <!-- Color Picker
                                                            <!-- <div id="color-picker">
